  ...
  return (
    <>
      {/* ═══════════════════════════════════════════
          HERO ROW
      ═══════════════════════════════════════════ */}
  <div className="relative mx-auto max-w-7xl px-4 py-32 sm:py-24 lg:px-8 lg:py-32">
        {/* Ambient blobs */}
        ...
        <div className="relative grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-24">
          ...
          <div className="relative order-1 lg:order-2">
            ...
            {/* Card */}
            <div className="relative w-full max-w-sm mx-auto rounded-3xl p-1 overflow-hidden aspect-[3/4] lg:max-w-none">
              <Image
                src={therpiest}
            ...
            <div className="absolute -bottom-6 right-2 sm:-right-6 z-20 max-w-[170px] sm:max-w-[200px] rounded-2xl border border-white/70 bg-white/85 p-3 sm:p-4 shadow-xl backdrop-blur-sm">
              <p className="text-[0.65rem] sm:text-[0.7rem] leading-relaxed text-[#6B7280] italic">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest text-[#7DA98D]">
                  Srishti Roy
                </span>
              </div>
            </div>
          ...
          <div className="order-2 lg:order-1 flex flex-col gap-6 sm:gap-8 mt-8 lg:mt-0">
            ...
            <div className="flex flex-col gap-1">
              <h2
                className="text-4xl font-bold leading-[1.05] tracking-tight text-[#3C4D5C] sm:text-5xl md:text-6xl lg:text-[5rem]"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
                Meet
              </h2>
              <h2
                className="text-4xl font-bold leading-[1.02] tracking-tight sm:text-5xl md:text-6xl lg:text-[5rem]"
                style={{
                  fontFamily: "'Playfair Display', Georgia, serif",
                  background:
                    "linear-gradient(135deg, rgba(169, 125, 125, 0.58) 0%, #4B7A8C 60%, #7DA98D 100%)",
              ...
              <p className="mt-3 text-[0.68rem] sm:text-[0.72rem] font-bold uppercase tracking-[0.18em] sm:tracking-[0.22em] text-[#7DA98D]/70">
            ...
            {/* Bio card */}
            <div className="relative rounded-3xl border border-white/80 bg-white/60 px-5 py-6 sm:px-7 sm:py-7 shadow-xl shadow-[#3C4D5C]/8 backdrop-blur-md">
              ...
              <p className="relative text-[0.9rem] sm:text-[0.97rem] leading-[1.85] sm:leading-[1.95] text-[#5A6472]">
                Srishti Roy is a
                <span className="font-semibold text-[#3C4D5C]">
                  {" "}
                  Canadian-trained Counselling Psychologist{" "}
                </span>
                and mental health professional supporting individuals, students,
                athletes, families, and culturally diverse populations across
                Canada and internationally. Her work is grounded in
                <span className="font-semibold text-[#3C4D5C]">
                  {" "}
                  evidence-based practice
                </span>
                , cultural sensitivity, and a deep commitment to helping
                individuals build resilience, self-awareness, and lasting
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
              {credentials.map((label) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-[#5A6472] leading-snug">
                    {label}
                  </span>
                </div>
              ))}
            ...
            <div className="rounded-xl bg-[#F7F4EF] border border-[#E7DDD2] px-4 py-3">
              <p className="text-sm font-medium text-[#3C4D5C]">
                Clinical Experience:{" "}
                <span className="font-semibold">3,200+ Hours</span>
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 pt-1">
              <Link
                href="/book"
                className="group inline-flex items-center justify-center gap-2.5 rounded-full bg-[#8D7A68] px-6 sm:px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#8D7A68]/30 transition-all duration-300 hover:scale-105 hover:bg-[#7A6858] hover:shadow-xl hover:shadow-[#8D7A68]/35"
              >
              ...
              <Link
                ...
                className="group inline-flex items-center justify-center gap-2.5 rounded-full border border-[#7DA98D]/50 bg-white/70 px-6 sm:px-7 py-3.5 text-sm font-semibold text-[#4B7A8C] backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-md"
              >
                Learn More
                <ArrowRight
                  size={15}
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-5 text-[#6B6578] text-[1.05rem] leading-relaxed max-w-lg">
                <p>
                  Drawing from Adlerian-informed and integrative therapeutic
                  approaches, her practice focuses on anxiety, trauma, emotional
                  regulation, life transitions, relationship concerns, and
                  identity development — grounded in evidence-based, culturally
                  sensitive care.
                </p>
              </div>
              ...
              <div className="relative mt-8 pl-6 border-l-2 border-[#CDB9F3]">
                <Quote
                  size={18}
                  className="absolute -top-1 -left-2 text-[#9B7AD9] fill-[#9B7AD9]"
                />
                <p
            ...
            {features.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-[1.05rem] font-semibold text-[#2A2535] mb-2">
                    {item.title}
                  </h3>
                  <p className="text-[#6B6578] text-sm leading-relaxed">
                    {item.desc}
                  </p>
                </motion.div>
              );
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-[#6B6578] max-w-lg mx-auto leading-relaxed">
              Integrating multiple evidence-based methods to best support your
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[0.8rem] font-semibold text-[#2A2535] text-center leading-tight">
                      {t.label}
                    </span>
                    <span className="text-[0.65rem] uppercase tracking-wider text-[#B89BEA] font-bold">
                      {t.tag}
                    </span>
                  </motion.div>
                </Link>
      ...
      {/* <motion.div
            ...
            >
              ...
              <p className="text-[#6B6578] text-[1.05rem] leading-relaxed mb-6 max-w-lg">
                With 3,000+ clinical hours across 12+ nationalities, Srishti
                brings deep expertise in trauma-informed care, cultural
                sensitivity, and evidence-based therapy — delivering real,
                lasting change for individuals, students, and athletes.
              </p>
              ...
              <p className="text-[#6B6578] text-[1.05rem] leading-relaxed mb-10 max-w-lg">
                ...
                <strong className="text-[#2A2535] font-medium">
                  South Asia, North America, Europe, the Middle East, Africa,
                  and the Caribbean
                </strong>{" "}
                ...
                Nigeria, Jamaica, Turkey, the UAE, the UK, Canada, Italy, and
                the United States has deepened her understanding of how culture,
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#F6F1EA] via-[#EFE7DC] to-[#E7DDD1] mb-12 py-24">
        ...
        >
          ...
          <p className="text-[#6E665D] text-lg md:text-xl leading-9 max-w-2xl mx-auto mb-10 font-light">
            Book a free 15-minute discovery call with Srishti Roy —
            Canadian-trained, Ontario-registered, and experienced across
            anxiety, trauma, life transitions, and relationship concerns.
            Sessions available in English, Hindi, Bengali & Urdu.
          </p>
