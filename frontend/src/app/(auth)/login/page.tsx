        ...
        <div className="hidden lg:flex lg:w-[48%] relative overflow-hidden bg-[#1C1629] flex-col justify-between p-12">
          ...
          <div className="relative z-10 flex flex-col gap-6">
            ...
            <blockquote className="font-cormorant text-4xl text-white/90 leading-[1.35] font-light italic">
              "Healing begins the moment you decide you are worth it."
            </blockquote>
          ...
          <div className="relative z-10 grid grid-cols-3 gap-6 border-t border-white/10 pt-8">
            {[['200+', 'Sessions'], ['98%', 'Satisfaction'], ['12+', 'Nationalities']].map(([val, label]) => (
              <div key={label}>
                <p className="font-cormorant text-2xl text-white/90 font-light">{val}</p>
          ...
          <div className="w-full max-w-sm mx-auto">
            <div className="mb-10 anim-up anim-d1">
              ...
              <p className="text-sm text-[#8B7FA8] mt-2 leading-relaxed">
                Manage your appointments with care.
              </p>
            </div>
              ...
              <div className="anim-up anim-d3">
                <div className="float-label relative">
                  <input
                    ...
                    required
                    className="w-full rounded-2xl border border-[#E2D9F3] bg-white text-sm text-[#1C1629] pr-12 focus:outline-none focus:border-[#9B7AD9] transition-colors"
                  />
                ...
                <div className="flex justify-end mt-2">
                  <Link href="/forgot" className="text-[11px] text-[#9B7AD9] hover:underline">
                    Forgot password?
                  </Link>
                </div>
              </div>
